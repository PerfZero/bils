        ...
        categories_data = [
            {
                ...
                'questions': [
                    {
                        'question': 'Как оформить покупку в интернет-магазине «Бигам»?',
...
<p>Вы можете оформить заказ по нашему бесплатному номеру 8-800-555-69-73 с 8-00 до 20-00 (звонок бесплатный по РФ), отправить заявку на почту help@bigam.ru или написать нам в онлайн-чате.</p>''',
            ...
            },
            {
                ...
                'questions': [
                    {
                        'question': 'Производит ли компания «Бигам» монтаж и установку оборудования (кондиционеры, сантехника и т.д.)?',
                        'answer': '<p>Компания «Бигам» не предоставляет услугу по монтажу и установке оборудования.</p>',
                        'order': 1
                    }
                ]
            },
            ...
            },
            {
                ...
                'questions': [
                    ...
                    {
                        'question': 'Какой режим работы магазинов «Бигам» в моем городе?',
...
<p>В рамках некоторых рекламных акций, проводимых Интернет-магазином «Бигам», могут выпускаться промокоды с иным ограничением на минимальную сумму Заказа.</p>
