        ...
        <section className="a-page-static__section">
          <div className="a-page-static__wrap">
            ...
            <div className="a-page-static__description a-page-static__description--new">
              <div
                className="banner banner--full-width banner--"
                picture=""
                url=""
              >
              ...
              >
                ...
                российских и мировых производителей для бесперебойной и
              ...
              >
                Мы имеем собственный авторизованный сервисный центр. Выполняем
                ремонт и обслуживание строительного оборудования и инструмента
                любой степени сложности. Оперативная диагностика неисправностей
                и выявление возможных причин поломки. Гарантия на выполненные
              ...
              <div className="advantages-list advantages-list--col-3">
                ...
                >
                  ...
                  <div className="advantage-card__content">
                    ...
                    <div className="advantage-card__text">
                      Техническое обслуживание техники. Диагностика, выезд
                      мастера
                    </div>
                  </div>
                </div>
              ...
              <div
                className="banner banner--small banner--reverse"
                picture=""
                url=""
              >
                <div className="banner__image">
                ...
                <div className="banner__content">
                  ...
                  <div className="banner__text">
                    ...
                    собственной логистической службой или проверенными
                    транспортными компаниями. Вы получите товар в
                    гарантированные сроки и по минимальным транспортным тарифам.
                    <br />
                    <br />
                  </div>
                  <ul className="banner__list-text" />
