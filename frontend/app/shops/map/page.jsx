...
export default function CatalogSlugPage({ params }) {
  const breadcrumbs = [{ label: "Главная", href: "/" }, { label: "Видео" }];
        ...
        <div className="a-page-shops__wrap">
          ...
          <div className="a-page-shops__switch">
            <menu className="a-main-switch">
              <a
                className="a-main-switch__option nuxt-link-active"
                href="/shops/"
              >
                Список
              </a>
                    ...
                    <ymaps className="ymaps-2-1-79-inner-panes">
                      ...
                      >
                        <ymaps>
                          ...
                          >
                            <ymaps className="ymaps-2-1-79-copyright__fog">
                              …
                            </ymaps>
                        ...
                        >
                          <ymaps>
                            <ymaps
                              ...
                              style={{
                                backgroundImage:
                                  'url("https://bremax.ru/images/components/map/marker_bigam_inactive.svg")',
                  ...
                  >
                    <ul className="a-main-map-list__list">
                      <li className="a-main-map-list__item">
                        <button
                          className="a-main-map-list__button"
                          type="button"
                        />{" "}
                      ...
                      <li className="a-main-map-list__item">
                        ...
                        <div className="a-main-map-list__address">
                          г. Владимир, ул. Гастелло 8А, ТСК Терминал, первый
                          этаж, вход 5Б
                        </div>{" "}
                        <div className="a-main-map-list__phones">
                          <a className="a-link-button" href="tel:+74922499929">
                      ...
                      <li className="a-main-map-list__item">
                        ...
                        <div className="a-main-map-list__address">
                          Ярославский р-н, пос. Красный Бор, ул. Васильковая, д.
                          2
                        </div>{" "}
                        <div className="a-main-map-list__phones">
                          <a className="a-link-button" href="tel:+74852282313">
