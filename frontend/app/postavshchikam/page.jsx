        ...
        <section className="a-page-static__section">
          ...
          <div className="a-page-static__wrap">
            ...
            <div className="a-page-static__description a-page-static__description--old">
              ...
              <p>
                «BREMAX» – это постоянно расширяющаяся сеть Центров продаж
                профессионального инструмента и техники. В нашем ассортименте
                более 600 категорий товаров известных мировых и отечественных
                брендов. Мы заботимся о наших клиентах и предлагаем только
                лучшее оборудование отличного качества и гарантируем приемлемые
                рыночные цены.
              </p>
              <p>
                С нами работают более 100 поставщиков. Мы заинтересованы в
                расширении сотрудничества, всегда приветствуем высокое качество
                и надежность в отношениях с нашими партнерами. Особое внимание
                мы уделяем региональным поставщикам и местным производителям,
                что является для них отличной платформой для поддержки и
                развития бизнеса.
              </p>
              <p>
                Если Вы хотите стать нашим поставщиком, рекомендуем ознакомиться
                с информацией ниже, в соответствующих разделах.
              </p>
              ...
              <ol>
                <li>
                  ...
                  предложение о сотрудничестве. В случае актуальности
                  предложения с Вами свяжется менеджер с уточнением необходимых
                  документов для сотрудничества.{" "}
                </li>
                <li>
                  Производится анализ спроса на предлагаемый товар/товарную
                  группу. Анализ коммерческих условий (отсрочка платежа,
                  бонусные программы, рекламный бюджет, гарантии постоянного
                  наличия, логистика, доставка и др.).{" "}
                </li>
              ...
              <p>
                Компания «BREMAX» всегда открыта для сотрудничества с новыми
                поставщиками. Мы заинтересованы в дистрибьюторах, которые могут
                предложить качественный товар в хороших объемах по доступным
                ценам. С нашей стороны мы предлагаем взаимовыгодные партнерские
                отношения, основанные на доверии, честности и прозрачности.
              </p>
              <p>
