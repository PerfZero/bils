  ...
  const videos = [
    {
      ...
      image:
        "https://cdn.bigam.ru/resize_cache/iblock/23a/g2cc3nskzq4qz4qonhhg1946tz5w1pl0/770_382_0/Prevyu-YUtub.jpg",
    ...
    },
    {
      ...
      image:
        "https://cdn.bigam.ru/resize_cache/iblock/7c8/9ii19986rcod7o7dg2mb9l17pgwcnv24/770_382_0/Prevyu.jpg",
  ...
  const articles = [
    {
      ...
      image:
        "https://cdn.bigam.ru/resize_cache/745199/c815982ac5e917f5de5d39415cbb16ea/iblock/012/012de650c95e6a96ed0fec58118d34f2/glavnaya.jpg",
    ...
    },
    {
      ...
      image:
        "https://cdn.bigam.ru/resize_cache/744897/c815982ac5e917f5de5d39415cbb16ea/iblock/f32/f3222c73e283f01b28adc72ceba59091/glavnaya.jpg",
        ...
        <div className="a-main-news">
                ...
                <div className="a-tabs-carousel a-main-tabs__carousel">
                  ...
                  >
                    {tabs.map((tab) => (
                      <SwiperSlide
                        key={tab.id}
                        className="a-tabs-carousel__slide"
                      >
                        <button
                          type="button"
                ...
                {activeTab === 0 && (
                  <section className="a-main-tabs__section a-main-tabs__section--active">
                    <div className="a-page-main__tab a-page-main__tab--videos">
                            ...
                            >
                              <div className="a-card-carousel__card">
                                <div className="a-light-news-card">
                                  <a
                                    href={video.href}
                                    className="a-light-news-card__picture"
                                  >
                                    <img
                                      src={video.image}
                                      alt={video.title}
                                  ...
                                  <a
                                    href={video.href}
                                    className="a-light-news-card__title"
                                  >
                                    {video.title}
                                  </a>
                                </div>
                      ...
                      <a
                        href="/videos/"
                        className="a-main-button a-page-main__button a-page-main__button--info-more a-main-button--display-inline a-main-button--type-large a-main-button--corner-round a-main-button--color-light-blue"
                      >
          ...
          <div className="a-main-news__column a-main-news__column--news">
            ...
            <div className="a-main-news__more">
              <a
                href="/about/novosti/"
                className="a-main-button a-page-main__button a-page-main__button--list-more-desktop a-main-button--display-inline a-main-button--type-large a-main-button--corner-round a-main-button--color-blue"
              >
                <span className="a-main-button__wrap">
              ...
              <a
                href="/about/novosti/"
                className="a-main-button a-page-main__button a-page-main__button--list-more-mobile a-main-button--display-inline a-main-button--type-large a-main-button--corner-round a-main-button--color-light-blue"
              >
                <span className="a-main-button__wrap">
                  <span className="a-main-button__content">Все новости</span>
                  <span className="a-main-button__constrain">
