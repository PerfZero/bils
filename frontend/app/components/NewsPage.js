  ...
  const newsData = [
    {
      ...
      date: '13.01.2026',
      image: 'https://cdn.bigam.ru/iblock/cd9/cd92d7692fcbb6d3a44d0aabe16a3083/713h260.jpg',
      imageAlt: 'Бигам расширяет свой ассортимент, представив обширную линейку алюминиевых и стальных лестниц и стремянок от Торговой марки SNIRREX.',
    ...
    },
    {
      ...
      date: '13.01.2026',
      image: 'https://cdn.bigam.ru/iblock/fd7/fd7589ba18ff0ba4356a1f0d51f6e70c/713h260.jpg',
      imageAlt: 'Готовьтесь к зиме с выгодой! «Скидка выходного дня -20%» в «Бигам»!',
      href: '/about/novosti/gotovtes-k-zime-s-vygodoi-skidka-vyhodnogo-dnya-20-v-bigam-/'
    },
    {
      id: '2049682',
      title: 'Режим работы «Бигам» в новогодние праздники 2026 год',
      date: '25.12.2025',
      image: 'https://cdn.bigam.ru/iblock/090/090f7069344f49f87e88176e66a7def3/grafik-raboty_5.jpg',
      imageAlt: 'Режим работы «Бигам» в новогодние праздники 2026 год',
    ...
    },
    {
      ...
      date: '04.12.2025',
      image: 'https://cdn.bigam.ru/iblock/ac4/ac4f0c49f5a0e62c8567cdf5583135a6/713h260-_7_.jpg',
      imageAlt: 'Воскресная скидка -20%',
      href: '/about/novosti/voskresnaya-skidka-20/'
    },
    {
      id: '2010264',
      title: 'В «Бигам» стартует БОЛЬШАЯ РАСПРОДАЖА со скидками до 30%',
      date: '12.09.2025',
      image: 'https://cdn.bigam.ru/iblock/824/824b3d60bfe35cfb88879d2e15d275f2/713h260-_6_.jpg',
      imageAlt: 'В «Бигам» стартует БОЛЬШАЯ РАСПРОДАЖА со скидками до 30%',
    ...
    },
    {
      ...
      date: '11.09.2025',
      image: 'https://cdn.bigam.ru/iblock/a36/a36d2bfef6185c7c3961c7ebed2768f7/svarka-SNIRREX_713h260.jpg',
    ...
    },
    {
      ...
      date: '19.08.2025',
      image: 'https://cdn.bigam.ru/iblock/1bd/1bd6ba68e0f45cac340c810f53a552b7/kompressory-SNIRREX_713h260_1_-_1_.jpg',
    ...
    {
      id: '1994487',
      title: 'БИГАМ приглашает ярославцев на грандиозный «Праздник инструмента»!',
      date: '14.08.2025',
      image: 'https://cdn.bigam.ru/iblock/fa4/fa4e2414dc3b2b91f67470f147fd7bc2/713h260_2.jpg',
      imageAlt: 'БИГАМ приглашает ярославцев на грандиозный «Праздник инструмента»!',
      href: '/about/novosti/bigam-priglashaet-yaroslavcev-na-grandioznyi-prazdnik-instrumenta-/'
    },
    {
      id: '1992571',
      title: 'БИГАМ приглашает жителей г. Кинешмы на грандиозный «Праздник инструмента»!',
      date: '07.08.2025',
      image: 'https://cdn.bigam.ru/iblock/a12/a12c2079be7b48ff94bf7b355b5bb19c/713h260_Kineshma.jpg',
      imageAlt: 'БИГАМ приглашает жителей г. Кинешмы на грандиозный «Праздник инструмента»!',
  ...
  return (
    <div className="a-page-news a-page__main">
      <div className="a-page-news__container">
        ...
        <BackButton href="/about/" text="О компании" className="a-page-news__back" />
      </div>
    ...
    <ul className="a-tags__groups">
      <li className="js-tags__group a-tags__group a-tags__group--hide">
        ...
        <ul className="js-tags__list a-tags__list">
          <li className="js-tags__item a-tags__item" style={{ display: "" }}>
            <div
            ...
            >
              ...
              >
                {/**/}{" "}
                <span className="a-ellipse-button__text">Режим работы</span>{" "}
                {/**/}
              </a>{" "}
              {/**/} {/**/}
            </div>
