  ...
  const products = [
    {
      ...
      image: "https://cdn.bigam.ru/resize_cache/681859/ae1d3c12631bcd92ab74e2237d30068a/iblock/6f9/6f97bb59793c635806fcd0010601254e/1147241.jpg",
      price: {
        current: "13 560 ₽",
        old: "13 840 ₽"
      },
    ...
    },
    {
      ...
      image: "https://cdn.bigam.ru/resize_cache/iblock/ca3/e50a5enry0yc8f01f2ms2hab0llfh25t/400_364_0/1124014.jpg",
      price: {
        current: "3 550 ₽"
      },
      rating: 4.0
          ...
          <div className="a-main-recommend-list__row">
            <div className="a-main-recommend-list__column">
              ...
              <div className="a-main-recommend-list__logo">
                ...
                <div className="a-main-recommend-list__logo-title">Рекомендует</div>
              </div>
            ...
            <div className="a-main-recommend-list__column">
              <ul className="a-main-recommend-list__list">
                {products.map((product) => (
                  <li key={product.id} className="a-main-recommend-list__item">
                    <div className="a-product-card a-product-card--type-vertical-vertical">
                      <a href={product.href} className="a-product-card__preview">
                        <img 
                          src={product.image} 
                          alt={product.title} 
                          title={product.title} 
                        ...
                        <div className="a-product-card__price">
                          <div className="a-price">
                            {product.price.current && (
                              <div className="a-price__current">{product.price.current}</div>
                            )}
                            {product.price.old && (
                              <div className="a-price__old">{product.price.old}</div>
                            )}
                          </div>
                        </div>
                          ...
                          <ul className="a-main-badge-list">
                            <li className="a-main-badge-list__item">
                              <div 
                                ...
                                style={{ '--badge-title': `'${product.badge.title}'`, backgroundColor: product.badge.color }}
                              ></div>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="a-product-card__helpers">
                        <div className="a-main-compare a-main-compare--type-vertical-vertical">
                          <div className="tooltip-main a-main-compare__tooltip tooltip-main--position-left" color="white">
                            <div className="tooltip-main__content">
                              <a href="/personal/compare/" className="a-link-button">
                                <span className="a-link-button__content a-link-button__content--black"></span>
                              </a>
                            </div>
                          </div>
                          <button title="В сравнение" type="button" className="a-main-compare__helper">
                        ...
                        <div className="a-main-like a-main-like--type-vertical-vertical">
                          <div className="tooltip-main a-main-like__tooltip tooltip-main--position-left" color="white">
                            <div className="tooltip-main__content">
                              <a href="/personal/favorites/" className="a-link-button">
                                <span className="a-link-button__content a-link-button__content--black"></span>
                              </a>
                            </div>
                          </div>
                          <button title="В избранное" type="button" className="a-main-like__helper">
                            ...
                            <span className="a-main-like__title a-main-like__title--to-favorite"></span>
                          </button>
                        </div>
                      </div>
                      <div className="a-product-card__buttons">
                        <button type="button" className="a-main-button a-product-card__add a-main-button--display-inline a-main-button--type-auto a-main-button--corner-round a-main-button--color-orange">
                          <span className="a-main-button__wrap">
                            <span className="a-main-button__content">В корзину</span>
                          </span>
                        </button>
                        <div className="a-product-card__mini-add">
                          <button type="button" className="a-main-button a-main-button--display-inline a-main-button--type-auto a-main-button--corner-round a-main-button--color-orange">
                            <span className="a-main-button__constrain">
                      ...
                      <a href={product.href} className="a-product-card__link"></a>
                    </div>
                  </li>
                ))}
              </ul>
