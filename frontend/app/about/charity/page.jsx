  ...
  <section className="a-page-static__section">
    ...
    <div className="a-page-static__wrap">
      ...
      <div className="a-page-static__description a-page-static__description--old">
        <p>
          Почему компания «BREMAX» занимается благотворительностью? Главная
        ...
        <p>
          <strong>
            Сегодня покупатели магазинов «BREMAX» и «Н2О», приобретая на кассе
            пакет для упаковки товара, помогают больным детям фонда РУСФОНД.
          </strong>
        </p>
        <p>
          Все денежные средства, вырученные с продажи пакетов, компания «BREMAX»
        ...
        <p>
          <strong>
            Также компания «BREMAX» помогает таким организациям, как:
          </strong>
        </p>
        <ul>
        ...
        <p>
          Кроме того, «BREMAX» проявляет содействие в проведении различных
