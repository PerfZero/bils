        ...
        <section className="a-page-static__section">
          ...
          <div className="a-page-static__wrap">
            ...
            <div className="a-page-static__description a-page-static__description--old">
              <p>BREMAX – это не только про работу, но и про отдых.</p>
              <p>
                Праздники, дни рождения компании, открытия новых филиалов и
                розыгрыши для клиентов мы традиционно проводим вместе.
              </p>
              <p>
              ...
              <p>
                <strong>
                  * Наша команда это не только сотрудники, но и их семьи. Для
                  них мы проводим творческие конкурсы и дарим подарки!
                </strong>
              </p>
              <p>
                <strong>
                  BREMAX - команда единомышленников, близких по духу и
                  ценностям!
                </strong>
              </p>
              <img
