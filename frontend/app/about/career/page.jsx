    ...
    <div className="a-page-static__wrap">
      ...
      <div className="a-page-static__sidebar">
        <div className="page-static-menu__list">
          ...
          <div className="page-static-menu__item">
            <a className="page-static-menu__link" href="/about/career/life/">
              Наша жизнь
            </a>
          </div>
          <div className="page-static-menu__item">
      ...
      <div className="a-page-static__description a-page-static__description--old">
        <h2>О Компании</h2>
        <p>
          Компания Бигам – Федеральная торговая сеть центров, один из крупнейших
          поставщиков профессионального рабочего оборудования, инструмента и
          техники.
        </p>
        <p>Наша компания:</p>
        <ul>
          <li>
            Топ-100 в Рейтинге работодателей hh.ru (в сегменте средних компаний)
          </li>
        ...
        <p
          ...
          {" "}
          <strong>Бигам - это 31 год успешной истории работы!</strong>
        </p>{" "}
        <img
          alt=""
        ...
        <p>
          Нам важно, чтобы каждый чувствовал себя комфортно и уверенно, работая
          вместе с нами.
        </p>
        <p>Работа в Бигам дает возможность:</p>
        <ul>
        ...
        <p>
          ...
          <br />
          Каждый из нас ежедневно заряжает своих коллег улыбкой и позитивом,
          уважительно относится к себе и к другим.
          <br />
        ...
        <p>
          ...
          профессиональные знания сотрудников возвращают к нам клиентов снова и
          снова.
          <br />
        </p>{" "}
        <img
        ...
        <p>
          ...
          <br />
          Каждый из нас анализирует свои достижения, улучшает технологии работы,
          совершенствует результат и непреодолимо движется к намеченным целям.
          <br />
        ...
        <p>
          ...
          Каждый из нас эффективно использует рабочее время и ресурсы компании,
          соблюдает дисциплину, правила и стандарты.
          <br />
          Наши действия, поступки и поведение влияют на происходящие вокруг нас
          события.
          <br />
        </p>{" "}
        <img
        ...
        />
        <h2>Работа в Бигам:</h2>
        <ul>
          <li>
            Стабильность – Работа в крупной развивающейся компании федерального
            уровня.
          </li>
          <li>Карьера – Перспектива роста и развития внутри компании.</li>
          <li>
            Самореализация – Воплощение идей, целей и личных  проектов в жизнь.
          </li>
          <li>
            Мотивация – Возможность влиять на уровень своего дохода. Размер
            оплаты труда, зависит от результатов работы самого сотрудника.
          </li>
        </ul>
      </div>
    </div>
