...
export default function ReviewsOfWorks() {
  ...
  const reviews = [
    {
      ...
      message: 'Сегодня приобретали снегоуборщик в магазине на Октябрьском 25. Хотелось бы поблагодарить продавцов-консультантов этого магазина. Ребята знают своё дело, грамотно могут помочь в выборе, сопровождают на всех этапах покупки, вплоть до загрузки её в автомобиль. Рекомендую этот магазин всем!',
      likes: 5,
      isExpanded: true
    },
    {
      ...
      message: 'Очень хороший магазин, советую всем, хороший товар, быстрая доставка и отличные курьеры,большое спасибо бигам!!!',
      likes: 4,
      isExpanded: true
    },
    {
    ...
    },
    {
      ...
      rating: 4.0,
      type: 'Хороший магазин',
      message: 'Хочется сказать спасибо всем сотрудникам Вашей компании за профессиональный подход к своей работе и внимательное, простое общение с заказчиком. Всем здоровья и хорошего настроения. С уважением Андрей',
      likes: 0,
      isExpanded: true
    },
    {
    ...
    },
    {
      ...
      rating: 5.0,
      type: 'Отличный магазин',
      message: 'Очень благодарны за компетентный обзор и вежливую продажу менеджеру Никита. по адресу Ярославль ул Силикатное шосссе',
      likes: 0,
      isExpanded: true
    },
    {
      ...
      rating: 5.0,
      type: 'Отличный магазин',
      message: 'Ассортимент достойный, нам нужны были определенные позиции, смотрели по своему списку приготовленному, по итогу сразу всё нашли. Цены вполне адекватные, сравнивали для себя разные места.',
      likes: 3,
      isExpanded: true
    },
    {
  ...
  const renderStars = (rating) => {
    return Array.from({ length: 5 }, (_, index) => {
      ...
      return (
        <li key={index} className={`a-rating__item ${isActive ? 'a-rating__item--active' : ''}`}>
          <svg className="a-svg a-rating__icon a-rating__icon--inactive a-rating__icon--color-grey">
            <use xlinkHref="#icon-star" xmlnsXlink="http://www.w3.org/1999/xlink" />
          </svg>
      ...
      <div className="a-shop-review-list">
        <ul className="a-shop-review-list__list">
          <li className="a-shop-review-list__item a-shop-review-list__item--total">
            <div className="a-shop-review-list__title">Общий рейтинг магазина</div>
            <div className="a-shop-review-list__group">
              <div className="a-shop-review-list__logo">
                <svg className="a-svg">
                  <use xlinkHref="#icon-last-bigam-logo-color" xmlnsXlink="http://www.w3.org/1999/xlink" />
                </svg>
              </div>
              <div className="a-shop-review-list__rating">
                <div className="a-rating">
                  ...
                  <div className="a-rating__count">{totalRating.rating}</div>
                </div>
              </div>
            </div>
            <div className="a-shop-review-list__count">{totalRating.reviewCount} отзыва</div>
          ...
          <li key={review.id} className="a-shop-review-list__item">
            <div className="a-review-card" id={review.id}>
              ...
              <div className="a-review-card__info">{review.date}, {review.location}</div>
              ...
              <div className={`a-spoiler a-title-indent ${review.isExpanded ? 'a-spoiler--open' : ''}`}>
              ...
              <button className="a-review-card__likes">
                <span className="a-review-card__likes-icon">
                  <svg className="a-svg">
                    <use xlinkHref="#icon-like" xmlnsXlink="http://www.w3.org/1999/xlink" />
                  </svg>
                </span>
                <span className="a-review-card__likes-text">{review.likes}</span>
              </button>
            </div>
          </li>
        ))}
...
<div className="a-page-reviews-of-works__footer">
  ...
  <div className="a-pagination">
    ...
    <a className="a-pagination__button" href="/about/reviews-of-works/?page=2">
