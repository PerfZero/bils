              ...
              <div className="containerPage">
                ...
                <div className="row">
                  ...
                  <div className="col-tl-4 col-mp-12 col-all">
                    <div className="blockBox">
                      ...
                      <p>
                        Вы всегда будете знать количество активных бонусов и
                        даты их сгорания
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-tl-4 col-mp-12 col-all">
                    <div className="blockBox">
                      ...
                      <p>
                        Вы всегда будете в курсе, на какой сейчас стадии ремонта
                        ваш инструмент в сервисном центре
                      </p>
                    </div>
                  </div>
                  <div className="col-tl-4 col-mp-12 col-all">
                    <div className="blockBox">
                      ...
                      <p>
                        Получите 200 бонусных рублей в подарок при первой
                ...
                <div className="row">
                  <div className="col-tl-12 col-mp-12 col-all">
                    ...
                    <ol>
                      <li>
                        Установите приложение BREMAX, предварительно скачав его
                        с любого подходящего сервиса (
                        <a
                      ...
                      <li>
                        Отсканируйте QR-код с рекламного плаката, размещенного
                        во всех розничных магазинах BREMAX
                      </li>
                      <li>
                        Просто обратитесь к любому сотруднику магазина: они
                        отправят вам СМС со ссылкой на установку и с
                        удовольствием ответят на любые вопросы о приложении
                      </li>
                    </ol>
                  </div>
                </div>
                <div className="row">
                  <div className="col-tl-12 col-mp-12 col-all">
                    ...
                    <p>
                      {" "}
                      <b>Если у вас уже есть бонусная карта BREMAX:</b>
                    </p>
                    <ol>
                      <li>
                        После установки авторизуйтесь в приложении: введите
                        номер телефона, привязанный к вашей бонусной карте
                      </li>
                    ...
                    <p>
                      {" "}
                      <b>Если у вас еще нет бонусной карты BREMAX:</b>
                    </p>
                    <ol>
                      <li>
                        Пройдите процедуру регистрации (заполните предложенные
                        поля)
                      </li>
                      <li>
                        На указанный вами телефон получите код для входа в
                        приложение
                      </li>
                    ...
                    <p>
                      {" "}
                      <i>
                        Примечание: Клиенты, которые ранее устанавливали
                        приложение, не могут получить бонусы
                      </i>
                    </p>
                    <p></p>
                  </div>
