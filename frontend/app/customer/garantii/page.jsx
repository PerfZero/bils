        ...
        <section className="a-page-static__section">
          ...
          <div className="a-page-static__wrap">
            ...
            <div className="a-page-static__description a-page-static__description--old">
              <p>
                Весь товар интернет-магазина <a href="/">bremax.ru</a> и сети
                центров инструмента и техники «BREMAX» качественный и имеет
                необходимые сертификаты качества. Если по каким-либо причинам
                Вам не понравится товар, можете его вернуть без объяснения
                причин в течение 7 дней, если Вы его не использовали.
              </p>
              <p>
                Интернет-магазин <a href="/">bremax.ru</a> работает в
              ...
              <p>
                ...
                Сервисных центрах. Сервисный центр компании «BREMAX» расположен
                по адресу г. Ярославль ул. Выставочная, д. 12. Подробнее о
                Сервисном центре можно узнать по этой
                <a href="/service/">ссылке</a>.
              </p>
              <h2>Обмен и возврат товара</h2>
              <p>
                При получении товара прежде чем расписаться в акте приемки,
                обязательно убедитесь в отсутствии внешних дефектов и
                комплектности вашего заказа.
              </p>
              <p>
                Претензии к внешнему виду товара в соответствии со ст. 458 и 459
                ГК РФ вы можете предъявить только до передачи Вам товара
                продавцом.
              </p>
              <p>
                При обнаружении скрытых дефектов в товаре, его обмен или возврат
                денежных средств Покупателю (на основании законодательства «О
                защите прав потребителей» от 07.02.1992 г. № 2300-1 )
                осуществляется после проведения проверки качества Cервисного
                центра.
              </p>
              <p>
                Подробные условия приемки, обмена и возврата товара указаны в
                разделе{" "}
