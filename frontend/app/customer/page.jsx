        ...
        <section className="a-page-static__section">
          ...
          <div className="a-page-static__wrap">
            ...
            <div className="a-page-static__description a-page-static__description--old">
              <h2>Как оформить покупку в интернет-магазине «BREMAX»?</h2>
              <h3>Оформление заказа через «Корзину товаров»</h3>
              <ol>
                <li>
                  На сайте выберите нужный товар, нажмите кнопку «В корзину» и
                  укажите количество.
                </li>
                <li>
                ...
                <li>
                  Выберите способ доставки (самовывоз или доставка в пункт
                  выдачи), ниже на странице введите свои данные, выберите способ
                  оплаты, еще раз проверьте правильность своего заказа и, если
                  требуется, укажите дополнительную информацию в комментарии.
                </li>
                <li>
                  Нажмите кнопку «Отправить заказ». Позже на вашу электронную
                  почту и телефон придет подтверждение заказа. Как заказ будет
                  готов, с вами свяжется наш менеджер и сообщит дату и место,
                  где можно получить товар.
                </li>
              </ol>
              ...
              <ol>
                ...
                <li>
                  В появившемся окне укажите свои данные и номер телефона,
                  нажмите кнопку «Отправить».
                </li>
                <li>
                  Дождитесь звонка нашего менеджера, который оформит ваш заказ.
                </li>
              </ol>
              ...
              <p>
                При регистрации на сайте и заказе товаров через Личный кабинет
                вы получаете несколько преимуществ:
              </p>
              <ul>
                <li>
                  нет необходимости вводить личные данные при каждом заказе,
                </li>
                <li>есть возможность отменить заказ без связи с менеджером,</li>
                <li>
                  есть возможность повторить заказ и узнать его статус на любом
                  этапе обработки,
                </li>
                ...
                <li>
                  доступна подписка на рассылку новостей и информацию о
                  предстоящих акциях.
                </li>
              </ul>
              <hr />
              <p>
                Если у вас возникли трудности с оформлением заказа или
                регистрацией на сайте, вы всегда можете обратиться к менеджерам
                контакт-центра по телефону горячей линиии
