  ...
  <section className="a-page-static__section">
    ...
    <div className="a-page-static__wrap">
      ...
      <div className="a-page-static__description a-page-static__description--old">
        <p>
          Нашли желанный товар по отличной цене или срочно нужен инструмент? Не
          упустите возможность его приобрести! В нашем магазине можно купить
          товар в рассрочку.
        </p>
        <p>
          Для комфортного совершения покупок и оформления заказов в
          интернет-магазине Бигам действуют системы рассрочки:
        </p>
        <div
          style={{
            alignItems: "center",
        ...
        <ul>
          ...
          <li>
            При оформлении заказа оплачивается 25% общей суммы. После внесения
            товар уже можно получить.
          </li>
        ...
        <ul>
          ...
          <li>
            Разных способах доставки товара: самовывозе из розничного магазина
            Бигам, доставке курьером или на пункт выдачи.
          </li>
        </ul>
        <p>
          {" "}
        ...
        <ol>
          <li>
            Отметить нужные товары из "Корзины" на сайте Бигам.{" "}
            <img
          ...
          <li>
            Выбрать рассрочку без переплат. Для этого флажок переводится вправо
            на текущей странице.{" "}
            <img
            ...
            />
            <p>
              Или нажать "Перейти к оформлению" и в выборе оплаты отметить "В
              рассрочку".{" "}
              <img
          ...
          <li>
            При оформлении заказа на сайте придет СМС-уведомление о присвоении
            ему номера. Далее откроется страница Плайт с выбором графика
            платежей.
            <img
              alt="График платежей"
              height="606"
            ...
            />
            <p>
              Нажимаем "Далее" и вводим телефон. Далее нужно заполнить небольшую
              анкету, где указываются имя, фамилия, дата рождения и электронная
              почта для проверки.
            </p>{" "}
          </li>
          <li>
            Если рассрочка одобрена, в открывшемся окне нужно ввести данные
            карты для списания первого платежа.
            <img
              alt="Первый платеж"
              height="575"
        ...
        <p>
          Халва – карта рассрочки, которая позволяет покупать товары у партнеров
          банка и в других магазинах без оплаты банковских процентов.
          Максимальный предоставляемый срок рассрочки – до 24 месяцев.
        </p>
        <p>
          {" "}
          <strong>Условия</strong>:
        ...
        <ul>
          ...
          <li>
            Платеж разбивается на части в соответствии с предоставленным сроком
            выплат.
          </li>
        ...
        <p>
          Для получения лучших условий при покупке в интернет-магазине Бигам
          можно оформить подписку "Халва. Десятка"
        </p>
        <p>
          Покупайте любые товары в БИГАМ в беспроцентную рассрочку до 10
          месяцев!
        </p>
        <p>
          При подключении подписки «ХАЛВА.ДЕСЯТКА» любые покупки в Бигам
        ...
        <p
          ...
          * Без подключения для клиентов Бигам действует беспроцентная рассрочка
          сроком на 2 месяца. Карта рассрочки «Халва». Плата за обслуживание - 0
          руб. Ставка в теч.льготного периода (36 мес.) - 0% год. При его
          нарушении по окончании-10% годовых. Лимит - до 350 000 руб. в теч.10
          лет. Срок рассрочки 1-18 мес. Общ.сумма переплаты - 0 руб. По факту
          просрочки неустойка 20 % годовых на сумму просроченной задолженности
          (за каждый день просрочки с 6-го дня). Клиентам 20-75 лет по паспорту
          РФ. Официальное трудоустройство (стаж на последнем месте работы не
          менее 4 мес). Наличие постоянной регистрации от 4 последних месяцев
          (на территории 1го населенного пункта РФ) и проживание в городе
          подразделений Банка или прилегающих населенных пунктах (но не более 70
          км от любого ВСП Банка). Наличие стационарного рабочего или домашнего
          телефона. ПАО «Совкомбанк». Ген.лицензия ЦБРФ №963.
        </p>
        <h2 id="faq">FAQ</h2>
        <div itemScope itemType="https://schema.org/FAQPage">
          ...
          <div
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  Нет. Списание платежей производиться по изначально выбранному
                  графику.
                </p>
              </div>
            </div>
          ...
          <div
            ...
            <p itemProp="name">
              {" "}
              <strong>Влияет ли плохая кредитная история на оформление?</strong>
            </p>
            <div
              itemProp="acceptedAnswer"
              itemScope
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  ...
                  8-800-505-52-17. Товары, приобретенные на розничных точка,
                  принимаются в магазинах Бигам.
                </p>
                <p>
                  Ознакомиться с правилами возврата товара в интернет-магазине
                  Бигам можно по <a href="/customer/returns/">ссылке</a>.
                </p>
                <p>
                  В случае возврата сумма оплаты за товар возвращается
                  покупателю магазином Бигам. Какие-либо изменения в программу
                  Плайт не вносятся.
                </p>
              </div>
            </div>
          ...
          <div
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  В указанный срок сумма будет списываться автоматически. Если
                  на карте будет недостаточно средств, то банк будет повторять
                  попытки списания и при неудаче свяжется с владельцем карты.
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            <p itemProp="name">
              {" "}
              <strong>
                Что делать, если возникли проблемы с использованием программы
                Плайт?
              </strong>
            </p>
            <div
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  ...
                  процентов банку при получении рассрочки. До 17% на остаток
                  своих средств.
                </p>
              </div>
            </div>
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  ...
                  оплатить покупку единовременно. Однако, при оформлении кредита
                  предстоит выплачивать проценты банку, нет льготных периодов по
                  выплате. Также получение кредита не дает бонусов в виде
          ...
          <div
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  У владельца есть еще 5 дней, чтобы внести необходимую сумму.
                  Далее будут действовать штрафные санкции.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <p itemProp="name">
              {" "}
              <strong>
                Есть ли уведомления об операциях по Халве? Какова их стоимость?
              </strong>
            </p>
            <div
              itemProp="acceptedAnswer"
              ...
              <div itemProp="text">
                <p>
                  Да. При операциях с картой на указанный при оформлении телефон
                  приходят push-уведомления или СМС.
                </p>
              </div>
            </div>
          </div>
            ...
            <div
              ...
              <div itemProp="text">
                <p>
                  ...
                  поддержки физических лиц Халва по номеру 8-800-100-77-72.
                </p>
              </div>
            </div>
          </div>
