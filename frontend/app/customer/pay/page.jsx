              ...
              <div className="static-pages-content">
                <div className="static-pages-content__item">
                  <p>
                    ...
                    интернет-магазина действуют следующие способы оплаты:
                  </p>
                  <ul className="static-pages-content__opened-list">
                    ...
                    <li className="static-pages-content__opened-list-item">
                      ...
                      (транспортная компания, розничный магазин «BREMAX») и при
                      доставке курьером. Вместе с заказом вам выдается кассовый
                  ...
                  <ul className="static-pages-content__opened-list">
                    ...
                    <li className="static-pages-content__opened-list-item">
                      <div className="pay__tab__content">
                        ...
                        <b> </b>
                        <p>
                          Вы можете оплатить товар банковской картой в точках
                          выдачи заказа (транспортная компания, розничный
                          магазин «BREMAX») и при доставке заказа курьером
                          только в г. Москве. Вместе с заказом вам выдается
                          кассовый чек и гарантийный талон.
                        </p>
                        <p>
                          Оплата заказа банковской картой при получении
                          (курьерской доставкой) доступно только в г. Москва.
                          Вместе с заказом вам выдается кассовый чек и
                          гарантийный талон. В других регионах данный способ
                          оплаты при получении недоступен.
                        </p>
                        <p>
                          К оплате принимаются банковские карты платежной
                          системы Visa, MasterCard, Maestro, МИР.
                        </p>
                        <p>
                          <b>
                            Расчет банковской картой в интернет-магазине
                            «BREMAX»{" "}
                          </b>
                        </p>
                        <p>
                        ...
                        <p>
                          К оплате принимаются банковские карты платежной
                          системы Visa, MasterCard, Maestro, МИР. Перевод
                          денежных средств осуществляется через процессинговый
                          центр, выполняющий интернет-эквайринг. После
                          подтверждения заказа вы будете перенаправлены на
                          защищенную платежную страницу, где необходимо ввести
                          данные Вашей банковской карты. После успешной оплаты
                          вы получите электронный чек. Информация, указанная в
                          чеке, содержит все данные о проведенной платежной
                          транзакции.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          (транспортная компания, розничный магазин «BREMAX») и
                          при доставке курьером при предъявлении паспорта или
                          иного документа, удостоверяющего личность
                          (загранпаспорт и т.п.). Вместе с заказом вам выдается
                          кассовый чек и гарантийный талон.
                        </p>
                      </div>
                    </li>
                  ...
                  <ul className="static-pages-content__opened-list">
                    <li
                      ...
                      onclick="this.nextElementSibling.classList.toggle('static-pages-content__opened-list-item_open');this.querySelector('.svg-static-content').classList.toggle('svg-static-content_open');"
                    >
                      Безналичный расчет (по выставленному счёту) для
                      юридических лиц{" "}
                      <img
                        alt=""
                        className="svg-static-content"
                    ...
                    <li className="static-pages-content__opened-list-item">
                      <div className="pay__tab__content">
                        <p>
                          ...
                          безналичному расчету (выставленный счет). Выдача
                          товара физическому лицу осуществляется только при
                          предъявлении документа, удостоверяющего личность
                          (паспорт или иной документ, удостоверяющий личность).
                        </p>
                        <p>
                          Представитель от юридического лица для получения
                          товара предоставляет платежное поручение и
                          доверенность (если получатель не имеет права подписи).
                        </p>
                        <p></p>
                        <p>
                    ...
                    <li className="static-pages-content__opened-list-item">
                      <div className="pay__tab__content">
                        <p>
                          ...
                          розничном магазине «BREMAX», выбрав товар в торговом
                          зале или предварительно оформив заказ в
                          интернет-магазине. Подробные условия использования
                          подарочной карты можно по{" "}
                        ...
                        <p>
                          ...
                          обо всех акциях и распродажа, проводимых в
                          интернет-магазине.
                        </p>
                        <p>
                          Так-же у наших клиентов есть возможность приобрести
                          дисконтную карту, которая позволяет приобретать товары
                          со скидками (карты действуют только в розничных
                          магазина «BREMAX»).
                        </p>
                      </div>
                    </li>
                  ...
                  <ul className="static-pages-content__opened-list">
                    ...
                    <li className="static-pages-content__opened-list-item">
                      <div className="pay__tab__content">
                        <p>
                          Для покупателей в розничных магазинах «BREMAX»
                          доступна возможность приобрести дисконтную карту и
                          воспользоваться скидками от 3 до 10%. Подробные
                          условия покупки и использования дисконтной карты можно
                          узнать по{" "}
                  ...
                  <ul className="static-pages-content__opened-list">
                    ...
                    <li className="static-pages-content__opened-list-item">
                      <div className="pay__tab__content">
                        ...
                        >
                          - Оставшиеся 75% будут списываться с вашей карты по
                          25% каждые 2 недели.
                        </span>
                        <br />
                        <p>
                        ...
                        <p>
                          ...
                          оплачиваете в течение 6 недель, по 25% каждые 2
                          недели.
                        </p>
                        <p>
                        ...
                        <p>
                          - Нет. Вы ничего не переплачиваете. Нет никаких
                          скрытых комиссий.
                        </p>
                        <p>
                          <b> Это кредит?</b>
                        ...
                        <p>
                          <b>
                            {" "}
                            Как будут списываться деньги за оставшиеся части?
                          </b>
                        </p>
                        <p>
                          - Всё работает также как в сервисах подписки,
                          например, Яндекс.Музыка или Spotify. Вы делаете первый
                          платёж, а дальше с вашей карты списываются средства
                          один раз в 2 недели.
                        </p>
                        <p>
                        ...
                        <p>
                          Оплатить заказ можно с помощью банковских карт
                        ...
                        <p>
                          ...
                          Best2Pay соответствует международным требованиями PCI
                          DSS для обеспечения безопасной обработки реквизитов
                          банковской карты плательщика. Ваши конфиденциальные
                          ...
                          процессингового центра Best2Pay и полностью защищена.
                          Никто, в том числе интернет-магазин{" "}
                        ...
                        <p>
                          ...
                          средств производится на ту же самую карту, с которой
