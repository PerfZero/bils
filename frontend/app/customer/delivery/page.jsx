        ...
        <section className="a-page-static__section">
          ...
          <div className="a-page-static__wrap">
            ...
            <div className="a-page-static__description a-page-static__description--old">
              <ol>
                <li>
                  <b>Самовывоз из Магазинов «BREMAX» (Бесплатно)</b>
                </li>
                <ul>
                  <li>
                    Как это работает: Заберите ваш заказ самостоятельно в любом
                    удобном розничном магазине «BREMAX».{" "}
                  </li>
                  <li>
                    Стоимость: абсолютно бесплатно при любой сумме заказа.{" "}
                  </li>
                  <li>
                  ...
                  <li>
                    Срок хранения: Готовый к выдаче заказ хранится 3 календарных
                    дня. Пожалуйста, заберите его вовремя, если не сможете
                    забрать – позвоните по бесплатному
                ...
                <ul>
                  <li>
                    ...
                    Яндекс.Доставка, СДЭК, DPD, а также используем нашу
                    собственную курьерскую службу.{" "}
                  </li>
                  <li>
                    Часы доставки: Курьеры работают с понедельника по
                    воскресенье с 09:00 до 22:00.{" "}
                  </li>
                  <li>Стоимость доставки: </li>
                  <p>   - Москва (внутри МКАД): от 400 руб.</p>
                  <p>
                    - Города: Ярославль, Александров, Муром, Рыбинск, Тверь,
                    Углич: от 450 руб.
                  </p>
                  <p>
                  ...
                  <li>
                    Оплата доставки: оплачивается вместе с заказом онлайн или в
                    вашем личном кабинете.
                  </li>
                  <li>Условия доставки:</li>
                  <p>
                    - Доставка осуществляется до подъезда (парадной) дома.
                    Услуги подъема на этаж и заноса в квартиру не
                    предоставляются.
                  </p>
                  <p>
                ...
                <ul>
                  <li>
                    Выбор даты и времени: после оформления заказа с вами
                    свяжется менеджер магазина, чтобы согласовать удобный для
                    вас день и временной интервал доставки.
                  </li>
                  <li>
                    Изменения в доставке: если вам потребуется изменить дату,
                    время или другие детали доставки, пожалуйста, оперативно
                    свяжитесь со своим менеджером.{" "}
                  </li>
                  <li>
                    Статус заказа и вопросы: Все вопросы по срокам сборки
                    заказа, точной стоимости доставки или отслеживанию
                    отправления задавайте менеджерам по
                    телефону: 8-800-555-69-73 (бесплатно по РФ).{" "}
                  </li>
                </ul>
              </ol>
              <p>
              ...
              <ol>
                <li>
                  Осмотрите коробку: убедитесь в целостности упаковки,
                  отсутствии повреждений, вмятин или следов вскрытия.{" "}
                </li>
                <li>
                  Проверьте товар и комплектацию: Вскройте упаковку (при курьере
                  или сотруднике магазина), осмотрите товар на предмет дефектов
                  и убедитесь в наличии всей комплектации.{" "}
                </li>
                <li>
                  Если обнаружена проблема (повреждение, брак, некомплект):{" "}
                </li>
                <ul>
                  <li>
                    Немедленно сообщите об этом курьеру или сотруднику
                    магазина.{" "}
                  </li>
